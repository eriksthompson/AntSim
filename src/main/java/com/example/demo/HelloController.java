...
//                }
                if(country2.size()>0) {
                        for (int i = 0; i < country2.size(); i++) {
                            ...
                            if (now - country2.get(i).getReproduceTime() > 5000000000.0) {
                                System.out.println("reproduce");
                ...
                if(country3.size()>0) {
                    for (int i = 0; i < country3.size(); i++) {
                        ...
                        if (now - country3.get(i).getReproduceTime() > 5000000000.0) {
                            System.out.println("reproduce");
                ...
                if(country4.size()>0) {
                    for (int i = 0; i < country4.size(); i++) {
                        ...
                        if (now - country4.get(i).getReproduceTime() > 5000000000.0) {
                            System.out.println("reproduce");
...
//                System.out.println("test");
    ...
    private ArrayList<Locations> tempLocs2 = new ArrayList<>();
    private ArrayList<Locations> tempLocs3 = new ArrayList<>();
    private ArrayList<Locations> tempLocs4 = new ArrayList<>();
    public void country1reproduce(int antNum){
        ...
        for(int i = ants.get(antNum).getY(); i<ants.get(antNum).getY()+2;i++){
            for(int j = ants.get(antNum).getX();j<ants.get(antNum).getX()+2;j++){
                if(ants.get(antNum).getY()<gameGrid.length && ants.get(antNum).getX() <gameGrid[0].length){
                    if(checkEmptyAroundMe(j,i)){
...
//            System.out.println("y: " +tempLocs.get(newLoc).getY());
            ants.add(new Ant(tempLocs.get(newLoc).getX(),tempLocs.get(newLoc).getY()));
//            System.out.println("y: " +tempLocs.get(newLoc).getY());
            gameGrid[ants.get(ants.size()-1).getX()][ants.get(ants.size()-1).getY()]=1;
    ...
    public void country2reproduce(int antNum){
        ...
        tempLocs2.clear();
        for(int i = country2.get(antNum).getY(); i<country2.get(antNum).getY()+2;i++){
            for(int j = country2.get(antNum).getX();j<country2.get(antNum).getX()+2;j++){
                if(country2.get(antNum).getY()<gameGrid.length && country2.get(antNum).getX() <gameGrid[0].length){
                    if(checkEmptyAroundMe(j, i)){
//                        System.out.println("j:" + j);
                        tempLocs2.add(new Locations(j, i));
                    }
                }
            }
        }
        if(tempLocs2.size()>0){
            int newLoc = (int)(Math.random()*tempLocs2.size());
//            System.out.println("y: " +tempLocs2.get(newLoc).getY());
            country2.add(new Country2(tempLocs2.get(newLoc).getX(),tempLocs2.get(newLoc).getY()));
//            System.out.println("y: " +tempLocs2.get(newLoc).getY());
            gameGrid[country2.get(country2.size()-1).getX()][country2.get(country2.size()-1).getY()]=1;
    ...
    public void country3reproduce(int antNum){
        ...
        tempLocs3.clear();
        for(int i = country3.get(antNum).getY(); i<country3.get(antNum).getY()+2;i++){
            for(int j = country3.get(antNum).getX();j<country3.get(antNum).getX()+2;j++){
                if(country3.get(antNum).getY()<gameGrid.length && country3.get(antNum).getX() <gameGrid[0].length){
                    if(checkEmptyAroundMe(j,i)){
//                        System.out.println("j:" + j);
                        tempLocs3.add(new Locations(i,j));
                    }
                }
            }
        }
...
////                        System.out.println("j:" + j);
//                        tempLocs4.add(new Locations(i,j));
//                    }
//                }
//            }
//        }
